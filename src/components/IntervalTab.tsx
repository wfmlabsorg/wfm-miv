...
export function IntervalTab({ callsPerWeek, days, forecastGoal }: Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">
          <Clock className="w-5 h-5 text-indigo-600 inline mr-2" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-indigo-500">
            <label className="block text-sm font-semibold text-gray-700 mb-1">Start Hour</label>
            <select
              value={startHour}
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-indigo-500">
            <label className="block text-sm font-semibold text-gray-700 mb-1">Distribution Shape</label>
            <select
              value={distShape}
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-indigo-500">
            <label className="block text-sm font-semibold text-gray-700 mb-1">Daily Calls</label>
            <div className="text-2xl font-bold text-gray-800">{Math.round(dailyCalls).toLocaleString()}</div>
            <div className="text-xs text-gray-500">{hoursOpen}h / {hoursOpen * 2} intervals</div>
          </div>
        </div>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-blue-500 transition-all hover:shadow-lg">
              <div className="text-2xl font-bold text-gray-800">{intervals.length}</div>
              <div className="text-sm text-gray-500 mt-1">Intervals</div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-red-500 transition-all hover:shadow-lg">
              ...
              <div className="text-sm text-gray-500 mt-1">Max MIV (tail intervals)</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-amber-500 transition-all hover:shadow-lg">
              ...
              <div className="text-sm text-gray-500 mt-1">Min MIV (peak intervals)</div>
            </div>
          </div>
